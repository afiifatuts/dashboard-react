...
function Ecommerce() {
  return (
    <div className="mt-20">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">Rp. 10.827.3723</p>
            </div>
          </div>
          {/* ---------Download Button-------------------- */}
          <div className="mt-6">
      ...
      {/* ------------First Syncfussion Element---------------- */}
      <div className="flex gap-10 flex-wrap justify-center ">
        <div
          className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3
        ...
        >
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">Rp. 23.000.000</span>
                  <span
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">Rp. 4.000.000</span>
                </p>
